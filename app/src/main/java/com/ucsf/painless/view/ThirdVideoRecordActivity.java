...
public class ThirdVideoRecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third_video_record);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_next:
                ...
                myDialog = new Dialog(ThirdVideoRecordActivity.this);
                ShowPopup();
    ...
    void start(Uri uri) {
        ProgressDialog pd = new ProgressDialog(ThirdVideoRecordActivity.this);
    ...
    void saveVideo(){
        if (!path.equals("")){
        saveVideoViewModel.saveThirdVideo(path.toString(),pvdo_id, ThirdVideoRecordActivity.this).observe(this, new Observer<FirstVideoResponse>() {
            @Override
            public void onChanged(@Nullable FirstVideoResponse loginResponse) {
                try {
                    if (loginResponse.isStatus()){
                        Intent n = new Intent(ThirdVideoRecordActivity.this, CongratulationsScreenActivity.class);
                        n.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        n.putExtra("msg", "You just completed a video update");
                        startActivity(n);
                    }else {
                        Toast.makeText(ThirdVideoRecordActivity.this, ""+loginResponse.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
